...
def calcul_volume():
    ...
    try:
        ...
        print("Distance: ", distance, " m\nVolume d'eau: ", volume_disponible, " m3")
...
def error():
    ...
    text = "Reset manual nécessaire"
    length=len(text)
    tft.text(vga1_8x8, text, tft.width() // 2 - length // 2 * vga1_8x8.WIDTH, 2 * tft.height() // 2 - vga1_8x8.HEIGHT//2, st7789.RED, st7789.BLACK)
    utime.sleep(1)
